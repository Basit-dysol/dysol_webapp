...
export default function ComputerVisionPage() {
  const process = [
    ...
    },
    {
      ...
      subdescription: ["Identity recognition and verification", "Attendance and presence tracking", "Access monitoring at scale", "Secure system integration"],
    },
    {
      ...
      <section className="w-full h-auto md:h-[500px] 2xl:px-32 text-white bg-[#1A1A1A] mt-[-20px] flex flex-col justify-center px-6 md:px-24 pt-12 md:pt-24 pb-8">
        ...
        <div className="mt-6">
          <button className="bg-white text-black px-6 py-3 rounded-[16px] text-sm font-medium flex gap-2">
            <img src="/computervision/computer-vision1.png" alt="" className="transition-transform duration-500 ease-[cubic-bezier(0.68,-0.55,0.27,1.55)] hover:translate-x-0.5" />
