    ...
    <section className="h-max py-20 2xl:py-28 mb-6 px-6 md:px-24 2xl:px-32 flex flex-col text-white/90 items-start justify-center">
      ...
      <div className="flex w-full flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col items-start justify-center flex-1">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-12 mt-6 relative">
            ...
            <div className="absolute left-0 right-0 top-1/2 h-0.5 border-[#4D4D4D]/80 border-t-2 border-dashed hidden md:block"></div>
            {logos.map((num) => (
              <div key={num} className="relative group size-full">
                {/* Default Logo */}
                <img
        ...
        <div className="flex flex-col text-white/80 w-full md:max-w-[35vw] text-base md:text-lg 2xl:text-2xl leading-relaxed flex-1">
          <p>
            With over
