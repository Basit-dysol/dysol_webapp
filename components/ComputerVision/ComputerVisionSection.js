      ...
      <section className="py-12 md:py-16 px-6 md:px-24 2xl:px-32 flex flex-col text-white/90">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 md:mb-12 gap-4">
          <h2 className="text-2xl md:text-[2rem] xl:text-[2.3rem] 2xl:text-[3rem] text-left leading-tight">
            We turn computer vision into deployed systems.
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-4 w-full">
          {visionProjects.map((project, index) => (
            <Link
              ...
              className="block h-[500px] md:h-[550px] lg:h-[700px] rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-700 group relative">
