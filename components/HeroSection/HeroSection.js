...
export default function HeroSection() {
  ...
  return (
    <>
      <section className="flex flex-col h-[50vw] xl:h-[60vw] 2xl:h-[100vh] text-white justify-end bg-[url('/LandingPage.png')] bg-cover rounded-4xl pb-16 xl:px-24 2xl:px-32 space-y-6 pr-0 xl:pr-[40vw] 2xl:pr-[40vw]">
