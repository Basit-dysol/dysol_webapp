...
export default function OurProcessCard({ image, description, subdescription, slug }) {
  ...
  return (
    <div
      className="w-[100%] h-120 rounded-2xl pt-20 overflow-hidden shadow-md p-6 relative border-[1px] border-white/10"
      style={{
      ...
      <div className="absolute left-0 right-0 bottom-0 p-6 text-gray-200 w-full z-10">
        <h3 className="text-2xl font-medium mb-2 text-white font-[Plus Jakarta]">{description}</h3>
        <p className="text-[15px] text-white/78 font-[Inter] font-normal">{subdescription}</p>
      </div>
    </div>
  );
  // ...existing code...
